...
(assert_instrumented $named_module_banana (module))
(; Assert shape of a module after the named module was instrumented… ;)
(assert_instrumented_gas $named_module (module))
(; Assert shape of a module after the named module was instrumented… ;)
(assert_instrumented_stack $named_module (module))

(; Can also refer to modules by index ;)
(assert_instrumented 2 (module))
(; Assert shape of a module after the named module was instrumented… ;)
(assert_instrumented_gas 2 (module))
(; Assert shape of a module after the named module was instrumented… ;)
(assert_instrumented_stack 2 (module))
